...
export function GamesBulkDeleteDialog({ open, onOpenChange, currentRows }: Props) {
  ...
  useEffect(()=>{
    if(_.get(data,'success',false)){
      onOpenChange(false)
      toast({
        title: 'The following games has been deleted:',
        description: (
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            This action will permanently remove the games from the system. This cannot be undone.
          </p>
