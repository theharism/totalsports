...
export function TeamsBulkDeleteDialog({ open, onOpenChange, currentRows }: Props) {
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            This action will permanently remove the teams from the system. This cannot be undone.
          </p>
